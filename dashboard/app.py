...
/* Keep native Streamlit collapse button visible and styled */
...
def main():
    ...
    # Add custom sidebar toggle button using components (executes JavaScript properly)
    ...
    .sidebar-toggle-btn {
        ...
        box-shadow: 0 0 20px rgba(220, 38, 38, 0.4), inset 0 0 20px rgba(220, 38, 38, 0.1) !important;
    ...
    .sidebar-toggle-btn:hover {
        background: linear-gradient(135deg, #2a1a1a 0%, #1a0f0f 100%) !important;
        border-color: #ef4444 !important;
        box-shadow: 0 0 30px rgba(220, 38, 38, 0.6), inset 0 0 30px rgba(220, 38, 38, 0.2) !important;
    ...
    .sidebar-toggle-btn:hover .bar {
        ...
        box-shadow: 0 0 12px rgba(239, 68, 68, 1) !important;
    }
    </style>
    <div class="sidebar-toggle-btn" id="customSidebarToggle" onclick="toggleSidebar()">
        <div class="bar"></div>
        <div class="bar"></div>
        <div class="bar"></div>
    </div>
    ...
    function toggleSidebar() {
        ...
        const collapseBtn = parent.querySelector('[data-testid="collapsedControl"] button');
        const expandBtn = parent.querySelector('button[kind="header"]');
        const sidebarCloseBtn = parent.querySelector('section[data-testid="stSidebar"] button[kind="header"]');
        ...
        if (collapseBtn) {
            ...
            allBtns.forEach(btn => {
                ...
                if (label && (label.toLowerCase().includes('sidebar') ||
